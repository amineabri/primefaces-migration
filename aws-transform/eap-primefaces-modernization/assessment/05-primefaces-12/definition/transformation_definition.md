# Assessment: PrimeFaces 11.0.0 To 12.0.0

Estimate the cost, time, effort, and risk for upgrading only PrimeFaces from 11.0.0 to 12.0.0.
...
Scope is PrimeFaces only. Do not include JBoss, Jakarta, Java, Docker, descriptor, or namespace migration in this estimate.
